class Insurance {
  ...
  String getBenefitLevelDescription() {
    const descriptions = {
      ...
      "2":
          "100% chi phí KCB có giới hạn tỷ lệ thanh toán một số thuốc, hóa chất, VTYT và DVKT",
  ...
  String getLivingAreaCodeDescription() {
    ...
    return livingAreaCode != null
        ? (descriptions[livingAreaCode] ?? "Unknown area code")
        : "";
  }
}
