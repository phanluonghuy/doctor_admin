                  ...
                  return TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      Utils.changeNodeFocus(context,
                          current: _currentPasswordFocusNode,
                          next: _newPasswordFocusNode);
                    },
          ...
          onPressed: () {
            if (_currentPasswordController.text.isEmpty) {
              Utils.flushBarErrorMessage(
                  'Current password must provide', context);
              return;
            }
            if (AppRegex.isValidPassword(_currentPasswordController.text) ==
                false) {
              Utils.flushBarErrorMessage(
                  'Current password must has 1 Lower, 1 Upper, 1 Number, 1 Symbols',
                  context);
              return;
            }
